...
- acquisition_category: tandem_mass_spectrum
  ...
  description: Mass spectrometry method used by EMSL for metabolomics analysis
...
```
## ChromatographicSeparationConfiguration-GC-has_calibration
### Input
```yaml
chromatographic_category: gas_chromatography
id: nmdc:cscon-99-oW43DzG1
stationary_phase: Polysiloxane
type: nmdc:ChromatographicSeparationConfiguration
...
has_configuration: nmdc:cscon-99-oW43DzG1
has_input:
- nmdc:procsm-11-9gjxns61
has_output:
...
ionization_source: electrospray_ionization
mass_analyzer: ion_cyclotron_resonance
mass_spectrum_collection_mode: full_profile
...
```
## ChromatographicSeparationConfiguration-compilation_example
### Input
```yaml
chromatographic_category: liquid_chromatography
id: nmdc:cscon-99-oW43DzG0
...
### Input
```yaml
has_configuration: nmdc:cscon-99-oW43DzG0
has_input:
- nmdc:procsm-11-9gjxns61
has_output:
- nmdc:procsm-11-05g48p90
...
```
## ChromatographicSeparationConfiguration-SPE
### Input
```yaml
...
```
## MaterialProcessing-sample-storage
### Input
```yaml
contained_in: falcon_tube
duration:
  has_maximum_numeric_value: 12
  has_unit: hours
  type: nmdc:QuantityValue
has_input:
