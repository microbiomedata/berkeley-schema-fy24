...
# Generation date: 2023-12-13T14:58:58
# Schema: NMDC
#
...
class WorkflowExecutionActivityId(PlannedProcessId):
    pass
...
@dataclass
class WorkflowExecutionActivity(PlannedProcess):
    """
...
slots.version = Slot(uri=NMDC.version, name="version", curie=NMDC.curie('version'),
                   model_uri=NMDC.version, domain=WorkflowExecutionActivity, range=Optional[str])
...
slots.NucleotideSequencing_id = Slot(uri=NMDC.id, name="NucleotideSequencing_id", curie=NMDC.curie('id'),
                   ...
                   pattern=re.compile(r'^(nmdc):dgns-([0-9][a-z]{0,6}[0-9])-([A-Za-z0-9]{1,})(\.[A-Za-z0-9]{1,})*(_[A-Za-z0-9_\.-]+)?$'))
...
slots.MassSpectrometry_id = Slot(uri=NMDC.id, name="MassSpectrometry_id", curie=NMDC.curie('id'),
                   ...
                   pattern=re.compile(r'^(nmdc):dgms-([0-9][a-z]{0,6}[0-9])-([A-Za-z0-9]{1,})(\.[A-Za-z0-9]{1,})*(_[A-Za-z0-9_\.-]+)?$'))
