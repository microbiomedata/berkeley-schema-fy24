...
class Migrator(MigratorBase):
    ...
    # A mapping from `workflow_chain_set` document `id` to its eventual `ends_at_time` value, if any.
    # Example: {'wfc-id-april': '2024-06-07T06:17:45+07:00', ...}
    id_to_ends_at_time_map = dict()
    ...
    def upgrade(self) -> None:
        ...
        self.adapter.process_each_document(
            collection_name="workflow_chain_set",
            pipeline=[self.set_replaces_field, self.set_ends_at_time_field],
        )
    ...
    def set_ends_at_time_field(self, workflow_chain: dict) -> dict:
        raise NotImplementedError  # TODO
